...
const (
	...
	SaveMode_ERRORIFEXISTS SaveMode = 1
	SaveMode_OVERWRITE     SaveMode = 2
	SaveMode_APPEND        SaveMode = 3
	SaveMode_IGNORE        SaveMode = 4
)
...
const (
	BatchEnsemblingJob_Unknown            BatchEnsemblingJob_JobKind = 0
	BatchEnsemblingJob_BatchEnsemblingJob BatchEnsemblingJob_JobKind = 1
)
...
const (
	Dataset_UNKNOWN Dataset_DatasetType = 0
	Dataset_BQ      Dataset_DatasetType = 1
)
...
const (
	Ensembler_UNKNOWN Ensembler_ResultType = 0
	Ensembler_DOUBLE  Ensembler_ResultType = 1
	Ensembler_FLOAT   Ensembler_ResultType = 2
	Ensembler_INTEGER Ensembler_ResultType = 3
	Ensembler_LONG    Ensembler_ResultType = 4
	Ensembler_STRING  Ensembler_ResultType = 5
...
const (
	Sink_UNKNOWN Sink_SinkType = 0
	// Output results to stdout. For testing only
	Sink_CONSOLE Sink_SinkType = 1
	// Writes results into a Google BQ table
	Sink_BQ Sink_SinkType = 2
)
...
func (x *BatchEnsemblingJob) GetKind() BatchEnsemblingJob_JobKind {
	...
	return BatchEnsemblingJob_Unknown
}
...
type Source struct {
	...
	JoinOn []string `protobuf:"bytes,2,rep,name=join_on,proto3" json:"join_on,omitempty"`
}
...
type Dataset_BqConfig struct {
	...
	BqConfig *Dataset_BigQueryDatasetConfig `protobuf:"bytes,2,opt,name=bq_config,proto3,oneof"`
}
...
type Sink struct {
	...
	SaveMode SaveMode `protobuf:"varint,3,opt,name=save_mode,proto3,enum=turing.batch.spec.SaveMode" json:"save_mode,omitempty"`
...
func (x *Sink) GetSaveMode() SaveMode {
	if x != nil {
		return x.SaveMode
	}
...
type Sink_BqConfig struct {
	// If `type` == SinkType.BQ
	BqConfig *Sink_BigQuerySinkConfig `protobuf:"bytes,10,opt,name=bq_config,proto3,oneof"`
}
...
type Ensembler_Result struct {
	...
	ColumnName string `protobuf:"bytes,1,opt,name=column_name,proto3" json:"column_name,omitempty"`
	...
	ItemType Ensembler_ResultType `protobuf:"varint,3,opt,name=item_type,proto3,enum=turing.batch.spec.Ensembler_ResultType" json:"item_type,omitempty"`
}
...
type Sink_BigQuerySinkConfig struct {
	...
	StagingBucket string `protobuf:"bytes,2,opt,name=staging_bucket,proto3" json:"staging_bucket,omitempty"`
	// List of an extra key-value config options, that is passed
	// into Spark-BQ connector.
	// The full list of supported options can be found here:
	// https://github.com/GoogleCloudDataproc/spark-bigquery-connector#properties
...
var file_api_proto_v1_batch_ensembling_job_proto_rawDesc = []byte{
	...
	0x67, 0x2e, 0x62, 0x61, 0x74, 0x63, 0x68, 0x2e, 0x73, 0x70, 0x65, 0x63, 0x22, 0xab, 0x02, 0x0a,
	...
	,
	...
	0xf7, 0x02, 0x0a, 0x16, 0x42, 0x61, 0x74, 0x63, 0x68, 0x45, 0x6e, 0x73, 0x65, 0x6d, 0x62, 0x6c,
	0x69, 0x6e, 0x67, 0x4a, 0x6f, 0x62, 0x53, 0x70, 0x65, 0x63, 0x12, 0x31, 0x0a, 0x06, 0x73, 0x6f,
	0x75, 0x72, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x75, 0x72,
	...
	,
	...
	,
	...
	0x08, 0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65,
	0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12,
	0x57, 0x0a, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x3d, 0x2e, 0x74, 0x75, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x62, 0x61, 0x74, 0x63, 0x68, 0x2e,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x22, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00,
	0x12, 0x06, 0x0a, 0x02, 0x42, 0x51, 0x10, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x22, 0x7c, 0x0a, 0x10, 0x50, 0x72, 0x65, 0x64, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x73, 0x65, 0x74, 0x52, 0x07, 0x64, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x12, 0x18, 0x0a, 0x07,
	0x6a, 0x6f, 0x69, 0x6e, 0x5f, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x6a,
	0x6f, 0x69, 0x6e, 0x5f, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73,
	0x22, 0xeb, 0x02, 0x0a, 0x09, 0x45, 0x6e, 0x73, 0x65, 0x6d, 0x62, 0x6c, 0x65, 0x72, 0x12, 0x10,
	...
	,
	...
	,
	...
	,
...
var file_api_proto_v1_batch_ensembling_job_proto_goTypes = []interface{}{
	(SaveMode)(0),                         // 0: turing.batch.spec.SaveMode
	(BatchEnsemblingJob_JobKind)(0),       // 1: turing.batch.spec.BatchEnsemblingJob.JobKind
	(Dataset_DatasetType)(0),              // 2: turing.batch.spec.Dataset.DatasetType
	(Ensembler_ResultType)(0),             // 3: turing.batch.spec.Ensembler.ResultType
	(Sink_SinkType)(0),                    // 4: turing.batch.spec.Sink.SinkType
...
var file_api_proto_v1_batch_ensembling_job_proto_depIdxs = []int32{
	1,  // 0: turing.batch.spec.BatchEnsemblingJob.kind:type_name -> turing.batch.spec.BatchEnsemblingJob.JobKind
	...
	2,  // 9: turing.batch.spec.Dataset.type:type_name -> turing.batch.spec.Dataset.DatasetType
	...
	4,  // 13: turing.batch.spec.Sink.type:type_name -> turing.batch.spec.Sink.SinkType
	0,  // 14: turing.batch.spec.Sink.save_mode:type_name -> turing.batch.spec.SaveMode
	...
	3,  // 18: turing.batch.spec.Ensembler.Result.type:type_name -> turing.batch.spec.Ensembler.ResultType
	3,  // 19: turing.batch.spec.Ensembler.Result.item_type:type_name -> turing.batch.spec.Ensembler.ResultType
