...
func (_m *CustomExperimentManager) GetExperimentRunnerConfig(_a0 json.RawMessage) (json.RawMessage, error) {
	ret := _m.Called(_a0)
...
func (_m *CustomExperimentManager) ValidateExperimentConfig(_a0 json.RawMessage) error {
	ret := _m.Called(_a0)
