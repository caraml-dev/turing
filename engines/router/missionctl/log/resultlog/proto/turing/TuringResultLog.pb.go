...
type Response struct {
	...
	// The response header from a Turing component (Enricher / Experiment Engine / Router / Ensembler), UTF-8-encoded.
...
func (x *Response) GetResponseBody() string {
	if x != nil {
...
func (x *Response) GetResponseHeader() string {
	if x != nil {
...
var file_TuringResultLog_proto_rawDesc = []byte{
	...
	0x22, 0x6e, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x27, 0x0a, 0x0f, 0x72, 0x65, 0x73, 0x70, 0x6f,
