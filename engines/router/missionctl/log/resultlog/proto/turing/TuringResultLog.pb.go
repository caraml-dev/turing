...
type Request struct {
	...
	Header map[string]*ListOfString `protobuf:"bytes,1,rep,name=header,proto3" json:"header,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *TuringResultLogMessage) Reset() {
	*x = TuringResultLogMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_TuringResultLog_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TuringResultLogMessage) Descriptor() ([]byte, []int) {
	return file_TuringResultLog_proto_rawDescGZIP(), []int{4}
}
...
var file_TuringResultLog_proto_rawDesc = []byte{
	...
	0x22, 0x24, 0x0a, 0x0c, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x66, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67,
	0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52,
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xa3, 0x01, 0x0a, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x74, 0x75, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x65, 0x71, 0x75,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x1a, 0x4f, 0x0a, 0x0b, 0x48,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65,
	0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x2a, 0x0a, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x74, 0x75,
	0x72, 0x69, 0x6e, 0x67, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x66, 0x53, 0x74, 0x72, 0x69, 0x6e,
	0x67, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x3c, 0x0a, 0x08,
...
var file_TuringResultLog_proto_goTypes = []interface{}{
	(*ListOfString)(nil),           // 0: turing.ListOfString
	(*Request)(nil),                // 1: turing.Request
	(*Response)(nil),               // 2: turing.Response
	(*TuringResultLogKey)(nil),     // 3: turing.TuringResultLogKey
	(*TuringResultLogMessage)(nil), // 4: turing.TuringResultLogMessage
	nil,                            // 5: turing.Request.HeaderEntry
	(*timestamppb.Timestamp)(nil),  // 6: google.protobuf.Timestamp
}
var file_TuringResultLog_proto_depIdxs = []int32{
	5, // 0: turing.Request.header:type_name -> turing.Request.HeaderEntry
	6, // 1: turing.TuringResultLogKey.event_timestamp:type_name -> google.protobuf.Timestamp
	6, // 2: turing.TuringResultLogMessage.event_timestamp:type_name -> google.protobuf.Timestamp
	1, // 3: turing.TuringResultLogMessage.request:type_name -> turing.Request
	2, // 4: turing.TuringResultLogMessage.experiment:type_name -> turing.Response
	2, // 5: turing.TuringResultLogMessage.enricher:type_name -> turing.Response
	2, // 6: turing.TuringResultLogMessage.router:type_name -> turing.Response
	2, // 7: turing.TuringResultLogMessage.ensembler:type_name -> turing.Response
	0, // 8: turing.Request.HeaderEntry.value:type_name -> turing.ListOfString
...
func file_TuringResultLog_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_TuringResultLog_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
