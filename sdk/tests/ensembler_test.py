...
def test_update_ensembler(
    turing_mock_request, mlflow_mock_request, gcs_mock_request,
    turing_api, project, generic_ensemblers, pyfunc_ensembler, use_google_oauth, active_project_magic_mock, experiment_name, experiment_id, artifact_uri, run_id, bucket_name
):
    turing.set_url(turing_api, use_google_oauth)
