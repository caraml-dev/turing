...
class RouterApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __projects_project_id_routers_version_ensembler_ensembler_id_get(
            self,
            project_id,
            ensembler_id,
            **kwargs
        ):
            """Returns Router Version based on ensembler  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.projects_project_id_routers_version_ensembler_ensembler_id_get(project_id, ensembler_id, async_req=True)
            >>> result = thread.get()
        ...
        self.projects_project_id_routers_version_ensembler_ensembler_id_get = _Endpoint(
            settings={
                'response_type': ([RouterVersion],),
                'auth': [],
                'endpoint_path': '/projects/{project_id}/routers-version-ensembler/{ensembler_id}',
                'operation_id': 'projects_project_id_routers_version_ensembler_ensembler_id_get',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__projects_project_id_routers_version_ensembler_ensembler_id_get
        )
