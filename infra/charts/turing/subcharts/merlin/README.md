...
| docsURL | string | `"https://github.com/caraml-dev/merlin/blob/main/docs/getting-started/README.md"` |  |
...
| image.repository | string | `"caraml-dev/merlin"` |  |
| image.tag | string | `"v0.9.1"` |  |
| imageBuilder.baseImage | string | `""` |  |
| imageBuilder.buildContextURI | string | `"git://TOKEN@github.com/caraml-dev/merlin.git#refs/tags/v0.1"` |  |
...
| imageBuilder.predictionJobBuildContextURI | string | `"git://TOKEN@github.com/caraml-dev/merlin.git#refs/tags/v0.1"` |  |
