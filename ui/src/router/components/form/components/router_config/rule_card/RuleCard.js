...
export const RuleCard = ({
  ...
  const routeSelectionOptions =
    rule.routes.length < routes.length
      ? [...rule.routes, "_none_"]
      : rule.routes;
  ...
  return (
    ...
    >
      ...
      {!isDefault ? (
        ...
        <EuiFormRow label="Conditions *" fullWidth>
          <EuiCallOut
            title="Conditions are disabled for the default rule."
            color="warning"
            iconType="help"
          >
            <p>
              The default rule will be triggered if no other rule matches the
              request.
            </p>
          </EuiCallOut>
        </EuiFormRow>
                  ...
                  >
                    {idx < rule.routes.length ? (
                      ...
                      <EuiButtonEmpty
                        ...
                        color="text"
                        onClick={() =>
                          onChange("routes")(routes.map((route) => route.id))
                        }
                      >
                        Select All
                      </EuiButtonEmpty>
