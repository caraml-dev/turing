...
func (_m *AlertService) FindByID(id models.ID) (*models.Alert, error) {
	...
	var r0 *models.Alert
	var r1 error
	if rf, ok := ret.Get(0).(func(models.ID) (*models.Alert, error)); ok {
		return rf(id)
	}
...
func (_m *AlertService) GetDashboardURL(alert *models.Alert, project *client.Project, environment *merlinclient.Environment, router *models.Router, routerVersion *models.RouterVersion) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(*models.Alert, *client.Project, *merlinclient.Environment, *models.Router, *models.RouterVersion) (string, error)); ok {
		return rf(alert, project, environment, router, routerVersion)
	}
...
func (_m *AlertService) List(_a0 string) ([]*models.Alert, error) {
	...
	var r0 []*models.Alert
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]*models.Alert, error)); ok {
		return rf(_a0)
	}
...
func (_m *AlertService) Save(alert models.Alert, authorEmail string, dashboardURL string) (*models.Alert, error) {
	...
	var r0 *models.Alert
	var r1 error
	if rf, ok := ret.Get(0).(func(models.Alert, string, string) (*models.Alert, error)); ok {
		return rf(alert, authorEmail, dashboardURL)
	}
