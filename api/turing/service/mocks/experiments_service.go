...
func (_m *ExperimentsService) ListClients(engine string) ([]manager.Client, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]manager.Client, error)); ok {
		return rf(engine)
	}
...
func (_m *ExperimentsService) ListExperiments(engine string, clientID string) ([]manager.Experiment, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) ([]manager.Experiment, error)); ok {
		return rf(engine, clientID)
	}
...
func (_m *ExperimentsService) ListVariables(engine string, clientID string, experimentIDs []string) (manager.Variables, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, []string) (manager.Variables, error)); ok {
		return rf(engine, clientID, experimentIDs)
	}
...
type mockConstructorTestingTNewExperimentsService interface {
	mock.TestingT
	Cleanup(func())
}

// NewExperimentsService creates a new instance of ExperimentsService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewExperimentsService(t mockConstructorTestingTNewExperimentsService) *ExperimentsService {
	mock := &ExperimentsService{}
	mock.Mock.Test(t)
