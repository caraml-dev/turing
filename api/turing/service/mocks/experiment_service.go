...
func (_m *ExperimentsService) GetExperimentRunnerConfig(engine string, cfg *manager.TuringExperimentConfig) (json.RawMessage, error) {
	...
	if rf, ok := ret.Get(0).(func(string, *manager.TuringExperimentConfig) json.RawMessage); ok {
		r0 = rf(engine, cfg)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, *manager.TuringExperimentConfig) error); ok {
		r1 = rf(engine, cfg)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ExperimentsService) ValidateExperimentConfig(engine string, cfg manager.TuringExperimentConfig) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, manager.TuringExperimentConfig) error); ok {
		r0 = rf(engine, cfg)
	} else {
		r0 = ret.Error(0)
	}
