...
func (_m *MLPService) GetEnvironment(name string) (*client.Environment, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*client.Environment, error)); ok {
		return rf(name)
	}
...
func (_m *MLPService) GetEnvironments() ([]client.Environment, error) {
	...
	var r0 []client.Environment
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]client.Environment, error)); ok {
		return rf()
	}
...
func (_m *MLPService) GetProject(id models.ID) (*apiclient.Project, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(models.ID) (*apiclient.Project, error)); ok {
		return rf(id)
	}
...
func (_m *MLPService) GetProjects(name string) ([]apiclient.Project, error) {
	...
	var r0 []apiclient.Project
	var r1 error
	if rf, ok := ret.Get(0).(func(string) ([]apiclient.Project, error)); ok {
		return rf(name)
	}
...
func (_m *MLPService) GetSecret(projectID models.ID, name string) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(models.ID, string) (string, error)); ok {
