...
func (_m *DeploymentService) DeployRouterVersion(project *client.Project, environment *merlin_apiclient.Environment, routerVersion *models.RouterVersion, routerServiceAccountKey string, enricherServiceAccountKey string, ensemblerServiceAccountKey string, experimentConfig json.RawMessage, experimentPasskey string, eventsCh *models.EventChannel) (string, error) {
	...
	var r0 string
	if rf, ok := ret.Get(0).(func(*client.Project, *merlin_apiclient.Environment, *models.RouterVersion, string, string, string, json.RawMessage, string, *models.EventChannel) string); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*client.Project, *merlin_apiclient.Environment, *models.RouterVersion, string, string, string, json.RawMessage, string, *models.EventChannel) error); ok {
...
func (_m *DeploymentService) UndeployRouterVersion(project *client.Project, environment *merlin_apiclient.Environment, routerVersion *models.RouterVersion, eventsCh *models.EventChannel) error {
	ret := _m.Called(project, environment, routerVersion, eventsCh)

	var r0 error
	if rf, ok := ret.Get(0).(func(*client.Project, *merlin_apiclient.Environment, *models.RouterVersion, *models.EventChannel) error); ok {
