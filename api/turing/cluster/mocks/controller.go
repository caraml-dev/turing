...
// RunJob provides a mock function with given fields: ctx, namespace, job
func (_m *Controller) RunJob(ctx context.Context, namespace string, job *cluster.Job) error {
	ret := _m.Called(ctx, namespace, job)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *cluster.Job) error); ok {
