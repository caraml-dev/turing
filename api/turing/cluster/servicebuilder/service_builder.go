...
func (sb *clusterSvcBuilder) NewEnsemblerService(
	...
	return sb.validateKnativeService(&cluster.KnativeService{
		BaseService: &cluster.BaseService{
			...
			Namespace:      namespace,
			Image:          docker.Image,
			CPURequests:    docker.EnsemblerContainerRuntimeConfig.ResourceRequest.CPURequest,
			MemoryRequests: docker.EnsemblerContainerRuntimeConfig.ResourceRequest.MemoryRequest,
		...
		MinReplicas:                     docker.EnsemblerContainerRuntimeConfig.ResourceRequest.MinReplica,
		MaxReplicas:                     docker.EnsemblerContainerRuntimeConfig.ResourceRequest.MaxReplica,
		TargetConcurrency:               knativeTargetConcurrency,
		QueueProxyResourcePercentage:    knativeQueueProxyResourcePercentage,
		UserContainerLimitRequestFactor: userContainerLimitRequestFactor,
	})
