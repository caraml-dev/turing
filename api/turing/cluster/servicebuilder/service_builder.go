...
func (sb *clusterSvcBuilder) NewEnsemblerService(
	...
	return sb.validateKnativeService(&cluster.KnativeService{
		BaseService: &cluster.BaseService{
			...
			Namespace:      namespace,
			Image:          docker.Image,
			CPURequests:    docker.ContainerRuntimeConfig.ResourceRequest.CPURequest,
			MemoryRequests: docker.ContainerRuntimeConfig.ResourceRequest.MemoryRequest,
		...
		MinReplicas:                     docker.ContainerRuntimeConfig.ResourceRequest.MinReplica,
		MaxReplicas:                     docker.ContainerRuntimeConfig.ResourceRequest.MaxReplica,
		TargetConcurrency:               knativeTargetConcurrency,
		QueueProxyResourcePercentage:    knativeQueueProxyResourcePercentage,
		UserContainerLimitRequestFactor: userContainerLimitRequestFactor,
	})
